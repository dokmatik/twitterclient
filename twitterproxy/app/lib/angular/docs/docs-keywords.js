NG_PAGES = [
    {
        ...
        "type": "overview",
        "keywords": "about angularjs api are check concepts developer documentation feature for guide if information more need new out overview recommend reference specific the to tutorial use we when you"
    },
    {
        "section": "api",
        "id": "angular.bind",
        "shortName": "bind",
        "type": "function",
        "keywords": "all also angular api are args arguments as be becomes bind bindings bound call calls can context currying evaluated feature fn for function in is known optional org prebound returns self should specified supply that the this to which wikipedia with wraps you"
    },
    {
        "section": "api",
        ...
        "shortName": "bootstrap",
        "type": "function",
        "keywords": "$injector an angular api app application array bootstrap created declarations dom element for function guide injector is manually module modules newly of returns root see start the this to up use which"
    },
    {
        "section": "api",
        "id": "angular.copy",
        "shortName": "copy",
        "type": "function",
        "keywords": "$filter about all an and angular any api are array arrays as augment be can copied copy created creates deep deleted destination elements expressions for from function if in including information into is it its make more must ng no not note null object objects of or primitives properties provided returned same see should source specified supplied that the then this to type undefined updated used was which will"
    },
    {
        "section": "api",
        "id": "angular.element",
    ...
    },
    {
        ...
        "shortName": "extend",
        "type": "function",
        "keywords": "all angular api by can copying destination dst extend extends from function multiple object objects of properties source specify src the to you"
    },
    {
        "section": "api",
        "id": "angular.forEach",
    ...
    },
    {
        ...
        "shortName": "fromJson",
        "type": "function",
        "keywords": "angular api deserialize deserialized deserializes fromjson function json string thingy to"
    },
    {
        "section": "api",
        "id": "angular.identity",
        "shortName": "identity",
        "type": "function",
        "keywords": "angular api argument code first function functional identity in is its return returns style that the this transformer useful value when writing"
    },
    {
        "section": "api",
        "id": "angular.injector",
    ...
    },
    {
        ...
        "shortName": "isArray",
        "type": "function",
        "keywords": "an angular api array check determines function if is isarray reference to true value"
    },
    {
        "section": "api",
        "id": "angular.isDate",
        "shortName": "isDate",
        "type": "function",
        "keywords": "angular api check date determines function if is isdate reference to true value"
    },
    {
        "section": "api",
        ...
        "shortName": "isDefined",
        "type": "function",
        "keywords": "angular api check defined determines function if is isdefined reference to true value"
    },
    {
        "section": "api",
        ...
        "shortName": "isElement",
        "type": "function",
        "keywords": "angular api check determines dom element function if is iselement jquery reference to true value wrapped"
    },
    {
        "section": "api",
        ...
        "type": "function",
        "keywords": "angular api check determines function if is isfunction reference to true value"
    },
    {
        "section": "api",
        "id": "angular.isNumber",
        "shortName": "isNumber",
        "type": "function",
        "keywords": "angular api check determines function if is isnumber number reference to true value"
    },
    {
        "section": "api",
        "id": "angular.isObject",
        "shortName": "isObject",
        "type": "function",
        "keywords": "an angular api are be but check considered determines function if in is isobject javascript not null object objects reference to true typeof unlike value"
    },
    {
        "section": "api",
        "id": "angular.isString",
        "shortName": "isString",
        "type": "function",
        "keywords": "angular api check determines function if is isstring reference string to true value"
    },
    {
        "section": "api",
        "id": "angular.isUndefined",
        "shortName": "isUndefined",
        "type": "function",
        "keywords": "angular api check determines function if is isundefined reference to true undefined value"
    },
    {
        "section": "api",
        ...
        "shortName": "lowercase",
        "type": "function",
        "keywords": "angular api be converted converts function lowercase lowercased specified string the to"
    },
    {
        "section": "api",
        "id": "angular.mock",
        "shortName": "mock",
        "type": "overview",
        "keywords": "angular angular-mocks api code contains from js mock namespace overview related testing which"
    },
    {
        "section": "api",
        ...
        "shortName": "dump",
        "type": "function",
        "keywords": "also an angular any api argument available be can common console debug debugging display dump elements etc for function globally injectable instance into is it just method mock not object objects of on serialized serializing string strings the this to turn used useful where window"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "module",
        "type": "function",
        "keywords": "access aliases also and angular anonymous any api are as automatically available be by code collects com configuration configure created easy example fns for function functions github http information initialization inject injector is it jasmine loaded mock module modules ng ngmock number of on only or published registers represented see string the this to usage used when which will window with"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "noop",
        "type": "function",
        "keywords": "angular api be calculateresult can code foo function functional in no noop operations performs result style that the this useful var when writing"
    },
    {
        "section": "api",
        "id": "angular.toJson",
        "shortName": "toJson",
        "type": "function",
        "keywords": "and angular api be contain function if input into json json-formatted jsonified newlines obj output pretty representing serialized serializes set string the to tojson true whitespace will"
    },
    {
        "section": "api",
        ...
        "shortName": "uppercase",
        "type": "function",
        "keywords": "angular api be converted converts function specified string the to uppercase uppercased"
    },
    {
        "section": "api",
        "id": "angular.version",
        "shortName": "version",
        "type": "property",
        "keywords": "about an angular angularjs api as code codename contains current dot following full has information jiggling-armfat major minor name number object of properties property release string such that the this version"
    },
    {
        "section": "api",
        "id": "AUTO",
        "shortName": "AUTO",
        "type": "overview",
        "keywords": "$injector added api auto automatically each gets implicit module overview to which"
    },
    {
        "section": "api",
        "id": "AUTO.$injector",
    ...
    },
    {
        ...
        "shortName": "ng",
        "type": "overview",
        "keywords": "all an angular api contains core is module ng of overview services the which"
    },
    {
        "section": "api",
        "id": "ng.$anchorScroll",
    ...
    },
    {
        ...
        "shortName": "$document",
        "type": "object",
        "keywords": "$document $window angular api browser document element jquery ng object reference the to window"
    },
    {
        "section": "api",
        ...
        "type": "function",
        "keywords": "$exceptionhandler $log about aids angular angular-mocks any api associated browser by cause console context default delegated delegates error exception expressions function if implementation in information into is it js loaded logs mock ng ngmock optional overridden service simply testing tests the this thrown to uncaught unit was which with"
    },
    {
        "section": "api",
        "id": "ng.$filter",
    ...
    },
    {
        ...
        "type": "function",
        "keywords": "$compile $interpolate $interpolateprovider $parse against an angular any api are binding by change compiles compute configuring context data defaults denote embedded end endsymbol evaluated exp expect expression expressions for function has have hello html if in injected interpolate interpolated interpolation into is markup method must musthaveexpression ng no null object of order parameters return see service set start startsymbol string strings symbol text the then these this to toequal true use used var which will with"
    },
    {
        "section": "api",
        "id": "ng.$interpolateProvider",
        "shortName": "$interpolateProvider",
        "type": "object",
        "keywords": "$interpolateprovider and api as configuring defaults denote end ending endsymbol expression for getter if in interpolated interpolation markup method new ng object of returns self set setter start starting startsymbol string symbol the to used value when"
    },
    {
        "section": "api",
        "id": "ng.$locale",
        "shortName": "$locale",
        "type": "object",
        "keywords": "$locale angular api as components en-us for formatted id is languageid-countryid locale localization ng now object of only provides public right rules service the various"
    },
    {
        "section": "api",
        "id": "ng.$location",
    ...
    },
    {
        ...
        "shortName": "$rootScope",
        "type": "object",
        "keywords": "$rootscope all and api application are child developer event every for guide has life-cycle mechanism model ng object of on other processing provide root scope scopes see single the watching"
    },
    {
        "section": "api",
    ...
    },
    {
        "section": "api",
        "id": "ng.$routeParams",
        "shortName": "$routeParams",
        "type": "object",
        "keywords": "$location $route $routeparams and api are case change collision com combination current even extracted given guarantees html http identity in is its likely matched moby name ng object occurs of over parameter parameters params path precedence properties remain route search sectionid service set take that the then unchanged url when will"
    },
    {
        "section": "api",
        "id": "ng.$routeProvider",
    ...
    },
    {
        ...
        "shortName": "$timeout",
        "type": "function",
        "keywords": "$apply $browser $exceptionhandler $rootscope $timeout and angular any api as associated be block by call can cancel canceled cancels checking deferred delay delayed delegates dirty exceptions executed execution false flush fn for function functions hasn if in into invoke is milliseconds model ng ngmock of otherwise promise queue reached registering rejection request resolved result return returned returns scope service set settimeout should skips successfully synchronously task tests that the this timeout to true try use value was when which who will window with within wrapped wrapper yet you"
    },
    {
        "section": "api",
        "id": "ng.$window",
        "shortName": "$window",
        "type": "object",
        "keywords": "$service $window alert all always angular api are available be because browser causes current don evaluated expressions for from global globality globally greeting hello in is it javascript may mocked ng ng-click ng-init ng-model object or overriden problems refer reference removed respect scope service so suffer testability testing text the they through to type variable we while window with world"
    },
    {
        "section": "api",
        "id": "ng.directive:a",
        "shortName": "a",
        "type": "directive",
        "keywords": "$save action allow api attribute behavior causing change changing creation default directive easy empty for href html is links location model modifies ng ng-click ngclick of or page prevented reasoning reloads so tag that the this to when with without"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "type": "inputType",
        "keywords": "$scope angular api assignable be change changes check checkbox control ctrl data-bind directive due element executed expect expression false form function html input inputtype interaction is it myform name ng ng-controller ng-false-value ng-model ng-true-value ngchange ngfalsevalue ngmodel ngtruevalue no not of property published selected set should state the to toequal true type under user value value1 value2 when which with yes"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "type": "inputType",
        "keywords": "$scope angular api assignable be blue button change changes color control ctrl data-bind directive due element executed expect expression form function green html input inputtype interaction is it myform name ng ng-controller ng-model ngchange ngmodel of property published radio red select selected set should state the to toequal type under user value when which with"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngApp",
        "type": "directive",
        "keywords": "add an and angular any api application at auto-bootstrap be below bootstrap can compiled designates directive document easiest element example html if in is load module name ng ngapp not of on one only optional page per placed resolved root the then this to typically use used way would"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngClick",
        "type": "directive",
        "keywords": "$event allows any api as available behavior check click clicked count custom directive doc-example-live element evaluate expect expression function guide increment is it ng ng-click ng-init ngclick object should specify the to tobe upon when you"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngCsp",
        "type": "directive",
        "keywords": "api application be directive don element enable enabled enables evaluator expression html if it mode mozilla need ng ngapp of on or org other performance policy root security should slightly so suffer support template the this unless used will with you"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "$event allows any api as available behavior custom dblclick directive evaluate event expression guide is ng ngclick ngdblclick object on see specify the to upon you"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "absence and angular api as attributes be binding browsers but button check checkbox checked chrome click compiler correctly directive disabled do doc-example-live enabled evaluated expect expression false following from function html ie8 ies input introduce isdisabled it make markup me means ng ng-disabled ng-init ng-model ngdisabled not of older on presence preserve prevents problem prop require retrieving scope should solve special specs such that the them this to tobefalsy tobetruthy toggle true type we will"
    },
    {
        "section": "api",
        ...
        "shortName": "ngForm",
        "type": "directive",
        "keywords": "alias allow api be controller controls determined directive does eac elements example for form forms html if into is it name needs nest nestable nesting ng not of published related scope specified sub-group the this to under useful validity will"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngInit",
        "type": "directive",
        "keywords": "any api be before bootstrap check directive during enters eval executed execution expect expression function greeting guide hello initialization it mode ng ng-init nginit person should specifies tasks template the to tobe world"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "type": "directive",
        "keywords": "$event allows any api as available behavior custom directive evaluate event expression guide is mousedown ng ngclick ngmousedown object on see specify the to upon you"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "$event any api as available behavior custom directive evaluate event expression guide is mouseenter ng ngclick ngmouseenter object on see specify to upon"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "$event any api as available behavior custom directive evaluate event expression guide is mouseleave ng ngclick ngmouseleave object on see specify to upon"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "$event any api as available behavior custom directive evaluate event expression guide is mousemove ng ngclick ngmousemove object on see specify to upon"
    },
    {
        "section": "api",
        ...
        "type": "directive",
        "keywords": "$event any api as available behavior custom directive evaluate event expression guide is mouseover ng ngclick ngmouseover object on see specify to upon"
    },
    {
        "section": "api",
        ...
        "shortName": "ngMouseup",
        "type": "directive",
        "keywords": "$event any api as available behavior custom directive evaluate event expression guide is mouseup ng ngclick ngmouseup object on see specify to upon"
    },
    {
        "section": "api",
        "id": "ng.directive:ngMultiple",
        "shortName": "ngMultiple",
        "type": "directive",
        "keywords": "absence and angular api as attributes be binding browsers check checkbox checked compiler correctly directive do doc-example-live evaluated expect expression false from function html id input introduce it me means multiple ng ng-model ng-multiple ngmultiple not of presence preserve prevents problem prop require retrieving select should solve special specs such that the them this to tobefalsy tobetruthy toggle true type we will"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngSrc",
        "type": "directive",
        "keywords": "angular any api attribute browser buggy can com contain correct directive doesn expression fetch from gravatar http img in inside it like literal markup ng ng-src ngsrc problem replaces right solves src string text the this to until url using way which will with work write"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngSubmit",
        "type": "directive",
        "keywords": "$scope action additionally and angular api binding check click ctrl current default directive doc-example-live element empty enables enter eval events expect expression expressions for form function guide hello hit id if ignore it list means name ng ng-controller ng-model ng-submit ngsubmit onsubmit page prevents push reloading request sending server should strings submit text the this to tobe type val value"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "script",
        "type": "directive",
        "keywords": "$templatecache api be by can click content currenttpl defined directive element expect function html id inlined inside into it load must ng ng-click ng-include nginclude ngview of or script set should so src tag template templates text that the to tomatch tpl-content tpl-link type used with"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "currency",
        "type": "filter",
        "keywords": "$1 $scope amount api as be ctrl currency current custom default displayed enter expect filter for formats formatted function identifier init input is it locale ng ng-controller ng-model no number or provided should symbol to tobe type update usd used when with"
    },
    {
        "section": "api",
        "id": "ng.filter:date",
    ...
    },
    {
        ...
        "shortName": "json",
        "type": "filter",
        "keywords": "allows and any api arrays automatically binding convert converted curly debugging double expect filter filtered for function into is it javascript json jsonify mostly name ng notation object objects primitive should string the this to tomatch types useful using value when you"
    },
    {
        "section": "api",
        ...
        "shortName": "limitTo",
        "type": "function",
        "keywords": "$filter $scope about an and angular api are array arrays as augment be beginning by containing copied creates ctrl doc-example-live either elements end enter entered exceed exceeds expect expressions filter first for from function had if in information input integer is it items length less limit limited limitto maximum more negative new ng ng-controller ng-model not note number numbers numer of only or output positive returned see should sign size source specified sub-array taken than the this three to tobe toequal trimmed type update used val value when will"
    },
    {
        "section": "api",
        ...
        "shortName": "lowercase",
        "type": "filter",
        "keywords": "angular api converts filter lowercase ng string to"
    },
    {
        "section": "api",
        "id": "ng.filter:number",
    ...
    },
    {
        ...
        "shortName": "uppercase",
        "type": "filter",
        "keywords": "angular api converts filter ng string to uppercase"
    },
    {
        "section": "api",
        "id": "ngCookies",
        "shortName": "ngCookies",
        "type": "overview",
        "keywords": "api ngcookies overview"
    },
    {
        "section": "api",
        ...
        "shortName": "$cookies",
        "type": "object",
        "keywords": "$browser $cookies $eval access adding and api are at browser by cookie cookies created current end examplecontroller exposed favoritecookie function is myfavorite new ngcookies oatmeal object of only or properties provides read removing retrieving setting simple the this to var"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "ngMock",
        "type": "overview",
        "keywords": "$injector adds an and angular api as auto configuration is mocks module ng ngmock overview the to unit-test used useful well which with"
    },
    {
        "section": "api",
        ...
        "shortName": "$exceptionHandler",
        "type": "object",
        "keywords": "$exceptionhandler $exceptionhandlerprovider $log $timeout and api assertempty banana capture configuration describe errors exceptions expect flush for function implementation information inject into it log logs messages mock mode module ng ngmock object of or passed peel rethrows see should that throw toequal"
    },
    {
        "section": "api",
        "id": "ngMock.$exceptionHandlerProvider",
        "shortName": "$exceptionHandlerProvider",
        "type": "object",
        "keywords": "$exceptionhandler $exceptionhandlerprovider $log allow an and any api application are array assertempty assertion bug case configures defaults desirable error errors fail for handler if implementation in into is it later log logging make means method mock mode ng ngmock object of operation or passed reset rethrow see sets so sometimes stores test tests that the them there these this throw to typically will"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "shortName": "$timeout",
        "type": "function",
        "keywords": "$timeout adds api decorator flush flushes for function is just method ng ngmock of pending queue service simple tasks that the this"
    },
    {
        "section": "api",
        "id": "ngMockE2E",
        "shortName": "ngMockE2E",
        "type": "overview",
        "keywords": "$httpbackend an angular api contains currently e2e end-to-end for in is mock mocks module ngmocke2e one only overview present suitable testing the there this which"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "type": "overview",
        "keywords": "api ngresource overview"
    },
    {
        "section": "api",
        ...
        "shortName": "$resource",
        "type": "object",
        "keywords": "$action $charge $http $inject $resource $save abc above access action action2 actions activities activity activityid actor actual after all allows an and any api appended are array arrives as assigned at automatically available be becomes before behaviors bound buzz buzzcontroller by callback calling came can card cardid cards case character charge class client collection colon com comments contains content could count create created creates credit creditcard crud custom data declaration default define definition delete depending destination each easily empty escape example excess execution existing expandreplies expect extend extended extracted factory false fetch first float following font-size for format from function get getresponseheaders gets getter given googleapis googlebuzz greet has hash having header headers hello high-level href html http https id if immediately important in instance instanceof instances interact invoke invoked invoking is isarray it item items itself jsfiddle json json_callback jsonp key keys let lets level like links ll look looks low mapped margin-left max-height means method methods mike model most name need never new newcard ng ng-click ng-controller ng-model ng-repeat ngresource no non non-get noting number object of on once one onto operations optional optionally or org other our overridden paramdefaults parameter parameterized parameters params passed perform populated port post postdata pre-bound prefix prefixed present profileurl prototype provide put putresponseheaders query re-renders read realize reference remove rendered rendering replies reply request resource response results retrieve returned returns rewrite right salutation save saved search section see server server-side service set should showing since smith so sources specified src static style success support template that the then these this thumbnailurl to toequal trick true type update url useful user userid using usually valid value values var view we well what when where which wikipedia with without worth write you your"
    },
    {
        "section": "api",
        "id": "ngSanitize",
        ...
        "type": "overview",
        "keywords": "api ngsanitize overview"
    },
    {
        "section": "api",
    ...
    },
    {
        ...
        "type": "overview",
        "keywords": "angular apps are before both check come completely details develop developer documents following getting guide here how if learn may misc of one or out overview place relatively returning right started the to tutorial unfamiliar use ve want web welcome with you"
    },
    {
        "section": "guide",
        "id": "overview",
    ...
    },
    {
        ...
        "shortName": "Type",
        "type": "overview",
        "keywords": "developer guide overview type"
    },
    {
        "section": "guide",
        "id": "di",
    ...
    },
    {
        ...
        "type": "overview",
        "keywords": "angular api apps are been brings client-side commonly controllers creating creating_services dependencies dependency dev_guide developer di feature for from guide have in injecting injecting_controllers injection into long managing managing_dependencies objects overview related server service services side substitutable testing testing_services that the time to together topics understanding understanding_services used using web where wired"
    },
    {
        "section": "guide",
    ...
    },
    {
        ...
        "type": "overview",
        "keywords": "about absolutely accept accepted access account add added afterwards agreement ahead aliases all already also always an and angular angular- angular-scenario angularjs annotations anonymous any api apis application applying are artifacts as at autotest available base based be before below best better branch browser browsers bug build building bundle by can capture case cd change changes characters check checked checking checkout chrome chromecanary cla click-through clone closure closures code com commit complete complex concise configure consistency consists console contained contains contents continuously contribute contributing contribution contributions contributor conventions coordinate copy corporations correct craft crafted crazy create creating debug default delete dependencies depending descriptive desired development different directories directory discussed do docs document documentation documented don duplication during e2e efforts either end-to-end end2end ensure entire even every exceptions execute executed existing explicitly export extended external fax features file files firefox first fixes follow following for fork forking form found from functions generate git github go good google googlecode grab guidance guide guidelines h1_1 h1_2 h1_3 h1_4 h1_5 have help here hierarchies hook hosted how however href html http https if implicitly in individuals information inheritance install installation installed installing instance instead instructions integration intend internal internally is it jasmine javascript js jsdoc just keep latest learn license licensed like linux list listed ll local located love machine machines macintosh made mail mailing main major make makes map markdown master mean merged message methods might min mind minified misc mit mode more most multiple must my-fix-branch name namespaces necessary need needed new ngdoc ngdocs node non-minified not notes npm npms objects of off often on once one only open opera or org origin other our out output over overview package packages page pass patch please plenty possible pre-configured pre-installed pre-packaged preconfigured prefer presubmit prevent private process productive project promise prototypical provided public pull purpose push quick quite rake rather re-run read release remote repository request requests reviewed rubyforge rules run runner running safari scan script see send sending sense server serves several should sign signed simple small so source standards start steps style submit submitted submitting successfully suite support sure system tag tasks templating terminal test testacular tested tests than thank that the them these this throughout time to today true type under unit unit-tests unless update upstream url use used useful username validate-commit-msg version via we web webserver website welcome what when whenever which with work working wrap write written xml you your yours zip"
    },
    {
        "section": "misc",
        "id": "downloading",
