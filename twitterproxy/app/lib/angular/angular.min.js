...
(function (X, Y, q) {
    ...
    function Kc(b, a) {
        ...
        for (var l = [], t, o = 0, p = [], s, J = ":"; o < b.length;) {
            ...
            if (c("\"'"))m(s); else if (e(s) || c(".") && e(d()))i(); else if (h(s)) {
                ...
                V ? (l.push({index: o, text: n, fn: V}), o += 2) : z ? (l.push({
                    index: o,
                    text: s,
                    fn: z,
                    json: "[,:".indexOf(J) != -1 && c("+-")
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", function (a, c, d) {
            ...
            e.prototype = {
                $new: function (a) {
                    ...
                    }, j = [h].concat(ha.call(arguments, 1)), n, q;
                    do {
                        e = f.$$listeners[a] || d;
                        h.currentScope = f;
                        n = 0;
    ...
    }, Ca = L.cache = {}, Ba = L.expando = "ng-" + (new Date).getTime(), oc = 1, $b = X.document.addEventListener ? function (b, a, c) {
    ...
    n({
        data: vb, inheritedData: Ea, scope: function (b) {
            return Ea(b, "$scope")
    ...
    n({
        ...
        }, clone: cb, triggerHandler: function (a,
                                                c) {
            var d = (ba(a, "events") || {})[c];
            n(d, function (c) {
                c.call(a, null)
    ...
    Cb.$inject = ["$provide"];
    var Ac = /^(x[\:\-_]|data[\:\-_])/i, Gb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, ac = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Hc = ac, Hb = {
        http: 80,
        https: 443,
        ftp: 21
    };
    ...
    }, Lc =
    {
        ...
        "'": "'",
        '"': '"'
    }, ib = {}, Yc = X.XMLHttpRequest || function () {
            try {
    ...
    var Qa = function (a) {
        ...
        }], yd = kb("", !0), zd = kb("Odd", 0), Ad = kb("Even", 1), Bd = Q({
                ...
                link: function (e, h, f, j) {
                    ...
                    function m(e, f, g) {
                        function h() {
                            ...
                            for (w = c.length; y < w; y++) {
                                ...
                                if (r.length <= y)p = {
                                    ...
                                    label: i.label
                                }, u = [p], r.push(u), f.append(p.element); else if (u = r[y], p = u[0], p.label != d)p.element.attr("label", p.label = d);
                                B = null;
                                A = 0;
                        ...
                        var j = c(i[2] || i[1]), k = i[4] || i[6], l = i[5], m = c(i[3] || ""),
                            n = c(i[2] ? i[1] : k), t = c(i[7]), r = [[{element: f, label: ""}]];
